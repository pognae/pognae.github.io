...
가장 중요한 규칙: 반드시 한국어(Korean)로만 작성해야 합니다. 외국어 문장이 그대로 출력되어서는 안 됩니다.`;
...
5. 아웃트로 (결론): "요약하자면", "결론적으로" 같은 AI 특유의 맺음말을 금지합니다. 독자에게 가벼운 질문을 던지거나 따뜻한 응원의 메시지로 자연스럽게 마무리하세요.
...
async function main() {
    try {
        ...
        // 애드센스 승인 심사를 위해 스팸성 자동 포스팅을 피하고, 고품질 글 1개만 생성합니다.
        const keywordsToProcess = keywords.slice(0, 1);
