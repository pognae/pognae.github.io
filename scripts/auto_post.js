...
가장 중요한 규칙: 반드시 한국어(Korean)로만 작성해야 합니다. 키워드가 외국어이더라도 본문은 한국어로 번역하여 설명하십시오. 외국어 문장이 그대로 출력되어서는 안 됩니다.`;
...
4. 글 구조:
   ...
   - 자주 묻는 질문(FAQ) 섹션 추가
   - 결론 및 요약
5. SEO 최적화: 자연스러운 키워드 반복, 가독성을 위한 불릿 포인트(-) 및 강조(**볼드**) 적극 활용.
6. 주의: 마크다운 문법으로만 출력하며, 글의 맨 앞이나 뒤에 "네, 알겠습니다" 같은 불필요한 인사말이나 부연 설명은 절대 넣지 마세요. 오직 블로그 본문만 출력하세요.`;
