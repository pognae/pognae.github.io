...
const tools = [
  ...
  { id: "aphugae", name: "아파트 호가", category: "money", render: renderAphugae },
  { id: "rent", name: "월세 부담", category: "money", render: renderRent },
  { id: "hourly", name: "시급 계산", category: "money", render: renderHourly },
  { id: "bonus", name: "상여금", category: "money", render: renderBonus },
  { id: "tipsplit", name: "N빵/더치페이", category: "money", render: renderTipsplit },
  { id: "inflation", name: "물가상승률", category: "money", render: renderInflation },
  { id: "budget", name: "예산 소진율", category: "money", render: renderBudget },
  { id: "cagr", name: "CAGR 성장률", category: "money", render: renderCagr },
  { id: "saving", name: "목표 저축 기간", category: "money", render: renderSaving },
  { id: "discount2", name: "중복 할인", category: "money", render: renderDiscount2 },
  { id: "vatback", name: "부가세 환급", category: "money", render: renderVatback },
  { id: "unitprice", name: "단가 계산", category: "money", render: renderUnitprice },

  { id: "ovulation", name: "배란일 계산", category: "date", render: renderOvulation },
  { id: "pregnancy", name: "출산 예정일", category: "date", render: renderPregnancy },
  { id: "countup", name: "경과일", category: "date", render: renderCountup },
  { id: "deadline", name: "남은 기한", category: "date", render: renderDeadline },
  { id: "wkcount", name: "남은 주차", category: "date", render: renderWkcount },
  { id: "retire", name: "은퇴 D-day", category: "date", render: renderRetire },
  { id: "timezone", name: "세계시간", category: "date", render: renderTimezone },

  { id: "whr", name: "허리엉덩이비", category: "health", render: renderWhr },
  { id: "ibw", name: "이상체중", category: "health", render: renderIbw },
  { id: "bmiplus", name: "BMI 목표 체중", category: "health", render: renderBmiplus },
  { id: "calburn", name: "활동 칼로리", category: "health", render: renderCalburn },
  { id: "protein", name: "단백질 섭취량", category: "health", render: renderProtein },
  { id: "dietburn", name: "다이어트 칼로리", category: "health", render: renderDietburn },
  { id: "dietterm", name: "감량 소요 기간", category: "health", render: renderDietterm },
  { id: "bac", name: "혈중알코올농도", category: "health", render: renderBac },
  { id: "alcunit", name: "알코올 단위", category: "health", render: renderAlcunit },

  { id: "paris", name: "할인율 역산", category: "life", render: renderParis },
  { id: "tvsize", name: "TV 시청거리", category: "life", render: renderTvsize },
  { id: "moving", name: "이사 짐 부피", category: "life", render: renderMoving },
  { id: "carbon", name: "탄소발자국", category: "life", render: renderCarbon },

  { id: "pixels", name: "px↔rem↔pt", category: "convert", render: renderPixels },
  { id: "shoe", name: "신발 사이즈", category: "convert", render: renderShoe },

  { id: "childage", name: "아기 개월수", category: "baby", render: renderChildage },
  { id: "dueweeks", name: "임신 주차", category: "baby", render: renderDueweeks },
  { id: "feedmilk", name: "분유량", category: "baby", render: renderFeedmilk },
  { id: "babycm", name: "아기 예상 키", category: "baby", render: renderBabycm },
  { id: "childcare", name: "보육료 예상", category: "baby", render: renderChildcare },

  { id: "gpa4", name: "학점 환산", category: "school", render: renderGpa4 },
  { id: "gpacalc", name: "평점 계산", category: "school", render: renderGpacalc },
  { id: "examavg", name: "시험 평균", category: "school", render: renderExamavg },
  { id: "examrank", name: "백분위 환산", category: "school", render: renderExamrank },
  { id: "examgoal", name: "목표 점수 차이", category: "school", render: renderExamgoal },
  { id: "stdscore", name: "표준점수", category: "school", render: renderStdscore },
  { id: "credit", name: "이수학점", category: "school", render: renderCredit },
  { id: "semester", name: "남은 학기", category: "school", render: renderSemester },

  { id: "recipe", name: "레시피 배율", category: "cook", render: renderRecipe },
  { id: "cookunit", name: "요리 단위", category: "cook", render: renderCookunit },
  { id: "cooktime", name: "해동/조리 시간", category: "cook", render: renderCooktime },

  { id: "pace", name: "페이스(분/km)", category: "sport", render: renderPace },
  { id: "race", name: "레이스 예상", category: "sport", render: renderRace },
  { id: "rep", name: "1RM 추정", category: "sport", render: renderRep },
  { id: "bodyfatgoal", name: "목표 체중", category: "sport", render: renderBodyfatgoal },

  { id: "petcal", name: "반려견 칼로리", category: "pet", render: renderPetcal },
  { id: "petage", name: "반려견 나이", category: "pet", render: renderPetage },
  { id: "petbmi", name: "반려동물 체중", category: "pet", render: renderPetbmi },
  { id: "petcost", name: "반려동물 비용", category: "pet", render: renderPetcost },

  { id: "taxi", name: "택시비 예상", category: "travel", render: renderTaxi },
  { id: "fuelcost", name: "유류비 계산", category: "travel", render: renderFuelcost },
  { id: "toll", name: "통행료 합산", category: "travel", render: renderToll },
  { id: "exchange", name: "환전 계산", category: "travel", render: renderExchange },
  { id: "travelbud", name: "여행 경비", category: "travel", render: renderTravelbud },

  { id: "textarea", name: "글자수 세기", category: "text", render: renderTextarea },
  { id: "reading", name: "읽기 시간", category: "text", render: renderReading },

  { id: "gcdlcm", name: "GCD/LCM", category: "math", render: renderGcdlcm },
  { id: "prime", name: "소수 판별", category: "math", render: renderPrime },
  { id: "pythag", name: "피타고라스", category: "math", render: renderPythag },
  { id: "roundcalc", name: "반올림/절사", category: "math", render: renderRoundcalc },
  { id: "ratio", name: "비율 계산", category: "math", render: renderRatio }
];
